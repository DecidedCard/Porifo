    ...
    return (
        <>
            {!isDeleteModalOpen ? (
                ...
                <div className="fixed inset-0 z-20 bg-gray3 flex items-center justify-center">
                    <div className="w-[440px] p-8 rounded-2xl bg-white flex flex-col items-center gap-4">
                        ...
                        <div className="flex gap-2 pt-4 justify-center w-[376px] h-[64px]">
                            <button
                                className="bg-gray2 pt-1 pr-3 pb-1 pl-3 w-[184px] h-[48px] rounded-xl font-spoqaMedium text-[16px] text-white"
