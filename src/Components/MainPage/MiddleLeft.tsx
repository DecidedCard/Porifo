        ...
        <main className="flex justify-center mr-40">
            <div className="flex flex-row gap-52 justify-center shrink-0 relative">
                <div className="flex flex-col gap-6 items-start justify-start shrink-0 relative">
                    <p className="tracking-wider font-spoqaMedium text-black text-left font-bold text-[40px] leading-normal relative flex items-center justify-start">
                        왜, 많은 개발자들이 <br /> 포리포로부터 시작할까요?
                    </p>
                    <p className="font-spoqaLight text-gray3 text-[20px] leading-tight relative self-stretch flex items-center justify-start">
