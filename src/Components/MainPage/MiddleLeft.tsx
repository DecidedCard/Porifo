        ...
        <main className="flex justify-center mr-40 sm:mx-10">
            <div className="flex flex-row gap-4 justify-center">
                <div className="flex flex-col gap-4 items-start justify-start sm:gap-6">
                    <p className="tracking-wider font-spoqaMedium text-black text-left text-H4_B sm:text-[22px]">
                        왜, 많은 개발자들이 <br /> 포리포로부터 시작할까요?
                    </p>
                    <p className="font-spoqaLight text-gray_4 text-SH4_M self-stretch sm:text-[12px]">
                    ...
                    <div>
                        <Link href={"/community"}>
                            <Button
                                ...
                                fontSize="s"
                                color="primary"
                                className="sm:w-[218px] sm:h-[48px] sm:font-medium sm:text-[14px]"
                            />
                        </Link>
                    </div>
                </div>
