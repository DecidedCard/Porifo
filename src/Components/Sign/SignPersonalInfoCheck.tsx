...
type PersonalCheck = { setPersonalInfoCheck: React.Dispatch<React.SetStateAction<boolean>> };

const SignPersonalInfoCheck = ({ setPersonalInfoCheck }: PersonalCheck) => {
    return (
                    ...
                    <div className="flex h-fit justify-items-end gap-2 relative ">
                        <div className="w-72 h-fit mt-6 mb-6 mx-auto">
                            <Button
                                ...
                                size="m"
                                text="취소하기"
                                onClick={() => setPersonalInfoCheck(false)}
                            />
                        </div>
