        ...
        <div>
            <ol className="flex flex-col items-start justify-start w-[800px] sm:items-center sm:justify-center">
                ...
                {project.map((project, index) => (
                    <li key={index} className="flex flex-col items-start justify-start w-[800px] rounded-lg border border-solid border-disabled p-4 sm:p-6 sm:w-[400px] sm:h-fit sm:items-center sm:justify-center">
                ...
                <div className="flex flex-col items-start justify-start w-[800px] sm:items-center sm:justify-center">
                    ...
                    <ol>
                        {career.map((experience, index) => (
                            <li key={index} className="flex mb-5 w-[800px] rounded-lg border border-solid border-disabled p-4 sm:p-6 sm:w-[400px] sm:h-fit sm:items-center sm:justify-center">
