        ...
        <main>
            ...
            <div className="my-12 flex flex-col items-start justify-start self-stretch shrink-0">
                            ...
                            <div className="flex flex-col w-[804px]">
                                ...
                                <div className="flex w-full flex-col">
                                    <div className="flex justify-between w-[804px] mt-5">
                                        ...
                                        <time className="text-middlegray text-[12px] font-normal leading-none">{project.date}</time>
                                    </div>

                                    {/* 설명과 상세 정보를 포함하는 영역 */}
                                    <div className="flex flex-col mt-5">
                                        <p className="text-[14px] font-normal mb-2 text-neutral-600">{project.introduce}</p>
                                        <div className="flex items-center text-neutral-600 mt-2">
                                            <RiLinkM className="mr-2" /><p className="text-[12px]">{project.githubLink}</p>
                                        </div>
                                        {project.deployLink && <div className="flex items-center text-neutral-600 mt-2">
                                            <RiLinkM className="mr-2" /><p className="text-[12px]">{project.deployLink}</p>
                                        </div>}
                                    </div>
                                </div>
                            </div>
                ...
                <div className="flex flex-col items-start justify-start mt-12 self-stretch shrink-0" >
                    <p className="font-bold text-[22px] w-[804px] h-[]">
                        기술스택
                    </p>
                </div>
