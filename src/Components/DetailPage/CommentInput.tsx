                ...
                {user ? (
                    <div className="flex gap-2">
                        ...
                        <textarea
                            ...
                            className="border border-solid border-gray2 w-full rounded-lg self-stretch h-[78px] text-[12px] p-3 sm:text-[10px] resize-none"
                        />
                    </div>
                ) : (
                    <textarea
                        placeholder="로그인을 해주세요"
                        className="border-[2px] border-solid border-gray2 rounded-lg self-stretch h-[78px] p-3 sm:text-[10px] resize-none"
                        disabled
                    />
                )}
                {/* 댓글등록 버튼 */}
