        ...
        <>
            <main className="flex justify-center bg-white rounded-2xl mt-20 ml-[75px] w-[705px] min-h-[817px] pb-5">
                <div className="flex flex-col gap-4">
                    <h1 className="flex items-center w-[657px] h-[46px] text-[30px] mt-4 font-bold tracking-wider">프로젝트</h1>
                            ...
                            return (
                                <div key={projectsIndex} className="flex flex-col gap-5 mt-4">
                                    ...
                                    <div className="flex mt-1">
                                        <label className="font-medium text-zinc-500 w-[177px] h-[32px] mt-2">기본정보</label>
                                    ...
                                    <div className="flex mt-1">
                                        <p className="font-medium text-zinc-500 w-[177px] h-[32px] mt-2">사진 업로드 하기</p>
                                    ...
                                    <div className="flex mt-1">
                                        <label className="font-medium text-zinc-500 w-[177px] h-[32px] mt-2">내용</label>
                                        <div className="w-[460px] ml-3 text-[14px]">
                                            <textarea
                                    ...
                                    <div className="flex mt-1">
                                        <label className="font-medium text-zinc-500 w-[177px] h-[32px] mt-2">프로젝트 기간</label>
                                        <div className="flex justify-between w-[460px]">
                                            <div className="w-[224px] ml-3">
                                                <Input
                                                    type="date"
                                                    size="big"
                                                    name="startDate"
                                    ...
                                    <div className="flex mt-1">
                                        <label className="font-medium text-zinc-500 w-[177px] h-[32px] mt-2">베포링크</label>
                                        <div className="w-[460px] ml-3">
                                            <Input
                                                type="url"
                                                size="big"
