                ...
                <div className="flex gap-3 sm:w-[60%] mx-auto">
                    ...
                    <div className="group relative flex flex-col gap-2 w-[460px]">
                            ...
                            {skillTag &&
                                skillTag.map((item, idx) => {
                                    return (
                                        <div
                                            key={idx}
                                            className="flex gap-2 py-[2px] px-3 w-fit h-[18px] text-[10px] font-medium text-white border border-solid border-primary bg-primary rounded"
                                        >
                                            {item}
                                            <p
                        ...
                        <div className="hidden group-hover:block">
                            <div className="flex flex-wrap justify-between gap-2 w-[460px] h-[48px] overflow-hidden bg-white sm:w-full sm:content-center">
