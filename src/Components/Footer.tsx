    ...
    return (
        <div className="bg-hihigray -z-10 h-[172px] px-[190px] py-[60px] flex flex-row gap-6 items-start sm:w-full sm:-ml-44 sm:flex-col">
            <Image
                ...
                height={80}
            />
            <div className="w-[1410px] h-[52px] flex flex-col gap-3 items-start justify-start text-sm text-gray3 sm:text-[12px] sm:w-[440px]">
                <p className="w-[622px] h-[20px] sm:w-[440px]">
