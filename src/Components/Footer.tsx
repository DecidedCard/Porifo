...
const Footer = () => {
    return (
        <div className="bg-hihigray -z-10 h-[172px] px-[190px] py-[60px] flex flex-row gap-6 items-start sm:items-center sm:justify-center sm:w-full sm:h-[318px] sm:py-10 sm:px-9 sm:flex-col">
